...
| Work | Primary classification | Work Type | Reason |
| --- | --- | --- | --- |
...
| Address a security concern that needs a new product requirement and a deployment safeguard | Two linked items: Product / Feature; Release / Operational Maintenance | — | The requirement decision and the operational safeguard have separate outcomes and evidence, so they are planned and traced separately. |
