...
| Address a security concern that needs a new product requirement and a deployment safeguard | Product, then Release | Feature plus Operational Maintenance as linked items | The requirement decision and the operational safeguard have separate outcomes and evidence, so they are planned and traced separately. |
